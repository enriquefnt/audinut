...
<div class="container">
   ...
   <!-- <div class="col-sm-0">
	...
	<div class="col-sm-6">
			...
			<input class="form-control form-control-sm"  type="text" id="CelularResp" name="Beneficiario[CelularResp]" placeholder="###-#######" data-llenar-campo="CelularResp" pattern="[0-9]{3}-[0-9]{7}"  value="<?=$datosCaso['CelularResp'] ?? ''?>" autocomplete="off" />
	</div>
